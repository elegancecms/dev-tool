...
use EleganceCMS\Base\Supports\Helper;
use EleganceCMS\DevTool\Helper as HelperDevTool;
...
class PackageRemoveCommand extends Command implements PromptsForMissingInput
{
    ...
    protected function processRemove(string $package, string $location): bool
    {
        ...
        $this->components->info(sprintf('Remove <comment>"elegancecms/%s": "*@dev"</comment> to composer.json then run <comment>composer update</comment> to remove this package!', $package));
