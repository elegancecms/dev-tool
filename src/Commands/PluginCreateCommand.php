...
namespace EleganceCMS\DevTool\Commands;

use EleganceCMS\DevTool\Commands\Abstracts\BaseMakeCommand;
use EleganceCMS\DevTool\Helper;
use EleganceCMS\PluginManagement\Commands\Concern\HasPluginNameValidation;
...
class PluginCreateCommand extends BaseMakeCommand implements PromptsForMissingInput
{
    ...
    public function inputOptions(): array
    {
        return [
            'id' => [
                ...
                'placeholder' => 'E.g.: elegancecms/example-plugin',
                'required' => true,
            ],
            'name' => [
                'label' => 'Name:',
            ...
            'namespace' => [
                'label' => 'Namespace:',
                'default' => 'EleganceCMS/{PluginName}',
            ],
            'provider' => [
    ...
    protected function registerAdvancedLanguage(): string|null
    {
        ...
        return PHP_EOL . str_repeat(' ', 12) . sprintf("if (defined('LANGUAGE_ADVANCED_MODULE_SCREEN_NAME')) {
                \EleganceCMS\LanguageAdvanced\Supports\LanguageAdvancedManager::registerModule(%s::class, [
                    'name',
                ]);
    ...
    protected function importsServiceProvider(): string|null
    {
        ...
        $imports = ['EleganceCMS\Base\Facades\DashboardMenu'];
